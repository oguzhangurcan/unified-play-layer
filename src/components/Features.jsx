      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
            ...
            experince on your world.
          </p>
        </div>

        <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-x-hidden rounded-md md:h-[65vh]">
          <BentoCard
            ...
            description="A cross-platform metagame app, turning your activities across Web2 and Web3 games into a rewarding advencutre."
          />
        </BentoTilt>
